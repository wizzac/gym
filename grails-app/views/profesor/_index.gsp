	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header card-header-primary">
				<h4 class="card-title"><g:message code="produ.label" default="Profesores"/></h4>
			</div>
			<div class="card-body">
				<div class="row">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<g:formRemote name="filter" url="[controller: 'Profesor', action: 'filter', params: parametros]" update="list" class="navbar-form">
				...
				<div class="row">
					<div class="col-md-12" id="list">
						<g:render template="list" model="[Profesores: profesores]"/>
					</div>
				</div>
			</div>
		</div>
