                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="card-header card-header-primary">
                                ...
                                <h4 class="card-title"><g:message code="default.edit.label" args="[message(code: 'cliente.label', default: 'Alumno')]" default="Editar Alumno"/></h4>
                            </div>
                            <g:formRemote name="create" update="[success: 'tr' + alumno.id, failure: 'errors']" url="[resource: alumno, action: 'update']" method="POST" onSuccess="closeModal()">
                                <div class="card-body">
